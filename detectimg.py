...
def detectimg(image, detector, text_threshold = 0.5, low_text = 0.4, link_threshold = 0.4, canvas_size = 2560, mag_ratio = 1., poly = False, gpu=True, imgH=64):
    '''
    Parameters:
    ...
    horizontal_list, free_list = group_text_box(text_box, add_margin = 0.1)
